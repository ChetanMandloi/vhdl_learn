...
compile()
{
  xmvlog -work xil_defaultlib $xmvlog_opts +incdir+"$ref_dir/../../../../PLL.gen/sources_1/bd/pll_design/ipshared/30ef" +incdir+"../../../../PLL.gen/sources_1/bd/pll_design/ipshared/30ef" \
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.pll_design xil_defaultlib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.pll_design -input simulate.do
}
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log pll_design_sc.so .tmp_log xcelium_lib waves.shm c.obj)
