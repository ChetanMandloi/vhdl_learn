...
#
# Script generated by Vivado on Mon Oct 09 13:46:07 IST 2023
...
compile()
{
  vlogan -work xpm $vlogan_opts -sverilog +incdir+"../../../../async_d_ff_Cloking.gen/sources_1/bd/design_1/ipshared/30ef" \
...
create_lib_mappings()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/home/dhep/vivado_proj/async_d_ff_Cloking/async_d_ff_Cloking.cache/compile_simlib/vcs"
  fi
