...
##Pmod Headers
##Pmod Header JA
set_property -dict { PACKAGE_PIN C17   IOSTANDARD LVCMOS33 } [get_ports { led1 }]; #IO_L20N_T3_A19_15 Sch=ja[1]
...
##Pmod Header JB
set_property -dict { PACKAGE_PIN D14   IOSTANDARD LVCMOS33 } [get_ports { led2 }]; #IO_L1P_T0_AD0P_15 Sch=jb[1]
