...
#
# Script generated by Vivado on Mon Oct 09 10:22:52 IST 2023
...
copy_setup_file()
{
  file="modelsim.ini"
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/home/dhep/vivado_proj/sync_d_flipflop/sync_d_flipflop.cache/compile_simlib/modelsim"
  fi
