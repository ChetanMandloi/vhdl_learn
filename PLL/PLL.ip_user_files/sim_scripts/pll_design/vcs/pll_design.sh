...
#
# Script generated by Vivado on Tue Oct 10 09:26:05 IST 2023
# SW Build 3865809 on Sun May  7 15:04:56 MDT 2023
#
# Tool Version Limit: 2023.05 
#
# Filename     : pll_design.sh
...
#
# Usage        : pll_design.sh
#                pll_design.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                pll_design.sh [-reset_run]
#                pll_design.sh [-reset_log]
#                pll_design.sh [-help]
#
...
#                script (type 'pll_design.sh -help' for more information).
#
...
# script info
echo -e "pll_design.sh - Script generated by export_simulation (Vivado v2023.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./pll_design.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
compile()
{
  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"$ref_dir/../../../../PLL.gen/sources_1/bd/pll_design/ipshared/30ef" +incdir+"../../../../PLL.gen/sources_1/bd/pll_design/ipshared/30ef" \
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.pll_design xil_defaultlib.glbl -o pll_design_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./pll_design_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key pll_design_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc pll_design_simv.daidir vcs_lib c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./pll_design.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: pll_design.sh [-help]\n\
Usage: pll_design.sh [-step]\n\
Usage: pll_design.sh [-lib_map_path]\n\
Usage: pll_design.sh [-reset_run]\n\
Usage: pll_design.sh [-reset_log]\n\
Usage: pll_design.sh [-keep_index]\n\
Usage: pll_design.sh [-noclean_files]\n\n\
