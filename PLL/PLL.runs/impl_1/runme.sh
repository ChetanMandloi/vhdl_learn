...
HD_PWD='/home/dhep/vivado_proj/PLL/PLL.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log using_PLLs.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source using_PLLs.tcl -notrace
