...
HD_PWD='/home/dhep/vivado_proj/PLL/PLL.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log using_PLLs.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source using_PLLs.tcl
