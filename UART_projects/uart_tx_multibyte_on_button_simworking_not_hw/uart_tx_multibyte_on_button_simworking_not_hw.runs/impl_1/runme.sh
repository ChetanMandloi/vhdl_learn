...
HD_PWD='/home/dhep/GitRepos/vhdl_learn2/UART_projects/uart_tx_multibyte_on_button_simworking_not_hw/uart_tx_multibyte_on_button_simworking_not_hw.runs/impl_1'
cd "$HD_PWD"
