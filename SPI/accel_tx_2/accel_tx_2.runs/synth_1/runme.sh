...
HD_PWD='/home/dhep/vivado_proj/accel_tx_2/accel_tx_2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log adxl362.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source adxl362.tcl
