...
HD_PWD='/home/dhep/vivado_proj/accel_tx_2/accel_tx_2.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log adxl362.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source adxl362.tcl -notrace
